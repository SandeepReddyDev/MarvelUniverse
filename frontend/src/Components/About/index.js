...
const About = () => {
  return (
    <div className="flex flex-col justify-center items-center about-c">
      <div className="dp-c">
      <img src="https://i.postimg.cc/kg5cf5DS/deadpool-stand.png" alt="dedpool" className="dp" />
      ...
      <div className="about-marvel w-full">
      ...
      <div className="about-marvel">
        ...
        <div id="achievments" className="about-marvel" style={{color: "white", fontSize: "20px", marginTop: "20px"}}>
          ...
          <div className="flex justify-center flex-row ml-0">
             <MarvelAcheivments />
          </div>          
